...
class Apitest(models.Model):
    ...
    apitestresult = models.BooleanField("测试结果") #接口测试结果
...
class Apistep(models.Model):
    Apitest = models.ForeignKey('Apitest', on_delete=models.CASCADE, null=True)  # 关联产品ID
    ...
    apiparmvalue = models.CharField("请求参数和值",max_length=800) #参数和值
